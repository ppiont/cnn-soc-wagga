...
########### Define Hyperparameters in the Skopt framework ############
...
def fitness(learning_rate,filter_eksponent,regu):
...
#####if you have run Bayesian optization earlier and want to continue then load previous history
...
checkpoint_saver = CheckpointSaver("directory_for_saving_optimization_history", compress=9)

#use this if you are starting a new optimization:
#Optimize using Gaussian Process minimizer (you can try other minimizeras as well :) )
